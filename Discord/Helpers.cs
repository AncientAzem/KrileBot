...
{
    public static async Task LogMessage(LogSeverity severity, string message, string source)
    {
        await DiscordClientService.LogDiscordMessage(new LogMessage(severity, message, source));
    }
